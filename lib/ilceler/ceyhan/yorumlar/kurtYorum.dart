...
class KurtYorum extends StatefulWidget {
  const KurtYorum({Key? key}) : super(key: key);

  @override
  _KurtYorumState createState() => _KurtYorumState();
}

class _KurtYorumState extends State<KurtYorum> {
  @override
