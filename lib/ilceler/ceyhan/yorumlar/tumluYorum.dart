...
class TumluYorum extends StatefulWidget {
  const TumluYorum({Key? key}) : super(key: key);

  @override
  _TumluYorumState createState() => _TumluYorumState();
}

class _TumluYorumState extends State<TumluYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('TumluYorum');
