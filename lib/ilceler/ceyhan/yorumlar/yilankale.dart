...
class YilanYorum extends StatefulWidget {
  const YilanYorum({Key? key}) : super(key: key);

  @override
  _YilanYorumState createState() => _YilanYorumState();
}

class _YilanYorumState extends State<YilanYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('YilanYorum');
