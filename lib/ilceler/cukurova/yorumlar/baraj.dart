...
class BarajYorum extends StatefulWidget {
  const BarajYorum({Key? key}) : super(key: key);

  @override
  _BarajYorumState createState() => _BarajYorumState();
}

class _BarajYorumState extends State<BarajYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('BarajYorum');
