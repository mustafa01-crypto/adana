...
class LagunYorum extends StatefulWidget {
  const LagunYorum({Key? key}) : super(key: key);

  @override
  _LagunYorumState createState() => _LagunYorumState();
}

class _LagunYorumState extends State<LagunYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('LagunYorum');
