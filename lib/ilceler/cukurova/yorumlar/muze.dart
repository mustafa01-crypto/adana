...
class MuzeYorum extends StatefulWidget {
  const MuzeYorum({Key? key}) : super(key: key);

  @override
  _MuzeYorumState createState() => _MuzeYorumState();
}

class _MuzeYorumState extends State<MuzeYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('MuzeYorum');
