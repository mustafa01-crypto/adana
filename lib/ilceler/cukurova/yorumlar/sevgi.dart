...
class SevgiYorum extends StatefulWidget {
  const SevgiYorum({Key? key}) : super(key: key);

  @override
  _SevgiYorumState createState() => _SevgiYorumState();
}

class _SevgiYorumState extends State<SevgiYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('SevgiYorum');
