...
class DokuzolukYorum extends StatefulWidget {
  const DokuzolukYorum({Key? key}) : super(key: key);

  @override
  _DokuzolukYorumState createState() => _DokuzolukYorumState();
}

class _DokuzolukYorumState extends State<DokuzolukYorum> {
  @override
