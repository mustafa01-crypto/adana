...
class KizildagYorum extends StatefulWidget {
  const KizildagYorum({Key? key}) : super(key: key);

  @override
  _KizildagYorumState createState() => _KizildagYorumState();
}

class _KizildagYorumState extends State<KizildagYorum> {
  @override
