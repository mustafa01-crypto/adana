...
class YerKopruYorum extends StatefulWidget {
  const YerKopruYorum({Key? key}) : super(key: key);

  @override
  _YerKopruYorumState createState() => _YerKopruYorumState();
}

class _YerKopruYorumState extends State<YerKopruYorum> {
  @override
