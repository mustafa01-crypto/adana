...
class AkcaTekirYorum extends StatefulWidget {
  const AkcaTekirYorum({Key? key}) : super(key: key);

  @override
  _AkcaTekirYorumState createState() => _AkcaTekirYorumState();
}

class _AkcaTekirYorumState extends State<AkcaTekirYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('AkcaTekirYorum');
