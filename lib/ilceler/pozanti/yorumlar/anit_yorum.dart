...
class AnitYorum extends StatefulWidget {
  const AnitYorum({Key? key}) : super(key: key);

  @override
  _AnitYorumState createState() => _AnitYorumState();
}

class _AnitYorumState extends State<AnitYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('AnitYorum');
