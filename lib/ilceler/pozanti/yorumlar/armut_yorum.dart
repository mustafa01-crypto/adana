...
class ArmutYorum extends StatefulWidget {
  const ArmutYorum({Key? key}) : super(key: key);

  @override
  _ArmutYorumState createState() => _ArmutYorumState();
}

class _ArmutYorumState extends State<ArmutYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('ArmutYorum');
