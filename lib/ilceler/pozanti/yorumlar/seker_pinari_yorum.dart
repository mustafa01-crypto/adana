...
class SekerPinariYorum extends StatefulWidget {
  const SekerPinariYorum({Key? key}) : super(key: key);

  @override
  _SekerPinariYorumState createState() => _SekerPinariYorumState();
}

class _SekerPinariYorumState extends State<SekerPinariYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    Query karapinarYorumlar =
        FirebaseFirestore.instance.collection('SekerPinariYorum');
