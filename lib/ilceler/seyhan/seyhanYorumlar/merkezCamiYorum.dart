...
class MerkezCamiYorum extends StatefulWidget {
  const MerkezCamiYorum({Key? key}) : super(key: key);

  @override
  _MerkezCamiYorumState createState() => _MerkezCamiYorumState();
}

class _MerkezCamiYorumState extends State<MerkezCamiYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    Query karapinarYorumlar =
        FirebaseFirestore.instance.collection('MerkezCamiYorum');
