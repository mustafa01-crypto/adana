...
class SaatKulesiYorum extends StatefulWidget {
  const SaatKulesiYorum({Key? key}) : super(key: key);

  @override
  _SaatKulesiYorumState createState() => _SaatKulesiYorumState();
}

class _SaatKulesiYorumState extends State<SaatKulesiYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    Query karapinarYorumlar =
        FirebaseFirestore.instance.collection('SaatKulesiYorum');
