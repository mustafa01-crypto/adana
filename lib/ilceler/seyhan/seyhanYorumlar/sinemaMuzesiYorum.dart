...
class SinemaMuzesiYorum extends StatefulWidget {
  const SinemaMuzesiYorum({Key? key}) : super(key: key);

  @override
  _SinemaMuzesiYorumState createState() => _SinemaMuzesiYorumState();
}

class _SinemaMuzesiYorumState extends State<SinemaMuzesiYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    Query karapinarYorumlar =
        FirebaseFirestore.instance.collection('SinemaMuzesiYorum');
