...
class AyasAntikYorum extends StatefulWidget {
  const AyasAntikYorum({Key? key}) : super(key: key);

  @override
  _AyasAntikYorumState createState() => _AyasAntikYorumState();
}

class _AyasAntikYorumState extends State<AyasAntikYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('AyasAntikYorum');
