...
class KizKalesiYorum extends StatefulWidget {
  const KizKalesiYorum({Key? key}) : super(key: key);

  @override
  _KizKalesiYorumState createState() => _KizKalesiYorumState();
}

class _KizKalesiYorumState extends State<KizKalesiYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('KizKalesiYorum');
