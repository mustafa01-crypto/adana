...
class SuleymanKulesiYorum extends StatefulWidget {
  const SuleymanKulesiYorum({Key? key}) : super(key: key);

  @override
  _SuleymanKulesiYorumState createState() => _SuleymanKulesiYorumState();
}

class _SuleymanKulesiYorumState extends State<SuleymanKulesiYorum> {
  @override
...
class _YorumlarState extends State<Yorumlar> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('SuleymanKulesiYorum');
